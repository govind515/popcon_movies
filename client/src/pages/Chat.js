  ...
  const generateText = async () => {
    try {
      ...
      const historyPrompt = conversationHistory
        .map((conv) => conv.generatedText)
        .join(" ");

      const response = await axios.post(
        "https://api.openai.com/v1/engines/text-davinci-003/completions",
        {
          prompt: `${historyPrompt} You are a helpful and knowledgeable AI, similar to Jarvis from Iron Man. Address the user with respect and provide informative and concise answers. The user's name is ${
                  ...
                  <div className="box-body">
                    <div className="direct-chat-messages">
                      ...
                      <div class="direct-chat-text">
                        Hello, I'm FilmBot, an AI here to answer your questions
                        on movies, TV shows, and anime. How can i help?{" "}
                      </div>
